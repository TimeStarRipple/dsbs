...
app.controller('MaterialPriceController', function($scope, $resource,$stateParams,$modal,$state,$localStorage) {
    ...
    $scope.addUpdate = function(data){
        ...
        $com.update({id:data.id},data,function(data){
            $state.go('app.materialPrice.list');
        });
    }
});